...
describe('Unit: Testing AuctionUtils "prepare_title_ending_data" ', function() {
  ...
  it('should prepare ua title', angular.mock.inject(['AuctionUtils', function(AuctionUtils) {
    expect(AuctionUtils.prepare_title_ending_data(auctionNew, 'ua'))
      .toEqual('UA-2016-10-29-000009-1 - [ТЕСТУВАННЯ] Варт гарбариха. - КОМУНАЛЬНЕ ПІДПРИЄМСТВО "КИЇВПАСТРАНС"');
  }]));
});
